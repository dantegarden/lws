...
func (r *LeaderWorkerSetReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		...
		Owns(&corev1.Service{}).
		Watches(&kruisev1beta1.StatefulSet{},
...
func SetupIndexes(indexer client.FieldIndexer) error {
	return indexer.IndexField(context.Background(), &kruisev1beta1.StatefulSet{}, lwsOwnerKey, func(rawObj client.Object) []string {
		// grab the statefulSet object, extract the owner...
		statefulSet := rawObj.(*kruisev1beta1.StatefulSet)
...
func (r *LeaderWorkerSetReconciler) rollingUpdateParameters(ctx context.Context, lws *leaderworkerset.LeaderWorkerSet, sts *kruisev1beta1.StatefulSet, revisionKey string, leaderWorkerSetUpdated bool) (int32, int32, error) {
	log := ctrl.LoggerFrom(ctx).WithValues("leaderworkerset", klog.KObj(lws))
	ctx = ctrl.LoggerInto(ctx, log)
...
func (r *LeaderWorkerSetReconciler) iterateReplicas(ctx context.Context, lws *leaderworkerset.LeaderWorkerSet, stsReplicas int32, revisionKey string) (int32, int32, error) {
	...
	var stsList kruisev1beta1.StatefulSetList
	if err := r.List(ctx, &stsList, stsSelector, client.InNamespace(lws.Namespace)); err != nil {
		return 0, 0, err
	}
	sortedSts := utils.SortByIndex(func(sts kruisev1beta1.StatefulSet) (int, error) {
...
func (r *LeaderWorkerSetReconciler) getLeaderStatefulSet(ctx context.Context, lws *leaderworkerset.LeaderWorkerSet) (*kruisev1beta1.StatefulSet, error) {
	sts := &kruisev1beta1.StatefulSet{}
...
func (r *LeaderWorkerSetReconciler) getOrCreateRevisionIfNonExist(ctx context.Context, sts *kruisev1beta1.StatefulSet, lws *leaderworkerset.LeaderWorkerSet, recorder record.EventRecorder) (*appsv1.ControllerRevision, error) {
	revisionKey := ""
	if sts != nil {
...
func (r *LeaderWorkerSetReconciler) getUpdatedRevision(ctx context.Context, sts *kruisev1beta1.StatefulSet, lws *leaderworkerset.LeaderWorkerSet, revision *appsv1.ControllerRevision) (*appsv1.ControllerRevision, error) {
	if sts == nil {
		return nil, nil
	}
